...
async def alter_name(gid: int, name: str):
    db = GroupModel()
...
async def alter_note(gid: int, note: str):
    db = GroupModel()
...
@router.post("/create")
async def create(data: GroupInfo):
    db = GroupModel()
...
async def add_user(data: UserGroupSer):
    db = GroupModel()
...
async def delete_user(uid: int, gid: int):
    db = GroupModel()
